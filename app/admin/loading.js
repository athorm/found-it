        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-orange-500/20 rounded-xl animate-shimmer" />
              <div className="space-y-2">
                <div className="h-5 w-36 bg-white/10 rounded animate-shimmer" />
                <div className="h-2 w-24 bg-orange-500/10 rounded animate-shimmer" />
              </div>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <div className="hidden sm:block h-9 w-28 bg-yellow-500/10 border border-yellow-500/20 rounded-xl animate-shimmer" />
            <div className="w-10 h-10 bg-white/5 rounded-xl animate-shimmer" />
          </div>
        </div>
      </header>
