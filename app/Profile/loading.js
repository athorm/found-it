  ...
  return (
    <div className="min-h-screen pb-20 font-sans text-white">
      ...
      <div className="sticky top-0 z-20 backdrop-blur-xl bg-black/40 border-b border-white/5 px-6 pt-4 pb-6 flex items-center justify-between">
        <div className="w-10 h-10 bg-white/5 rounded-full animate-shimmer shrink-0" />
        <div className="h-8 w-28 bg-white/10 rounded animate-shimmer" />
        <div className="w-10 h-10 bg-white/5 rounded-full animate-shimmer shrink-0" />
      </div>

      <main className="px-6 mt-8 max-w-lg mx-auto space-y-6">
        {/* Profile Card Skeleton */}
        <div className="rounded-[2.5rem] bg-orange-500/[0.03] backdrop-blur-xl border border-orange-500/20 p-8 flex flex-col items-center animate-shimmer">
          {/* Avatar */}
        ...
        <div className="rounded-3xl bg-white/[0.02] backdrop-blur-md border border-white/5 overflow-hidden animate-shimmer">
          {[1, 2].map((i) => (
        ...
        <div className="rounded-3xl bg-red-500/[0.02] backdrop-blur-md border border-red-500/10 overflow-hidden animate-shimmer">
          {[1, 2].map((i) => (
