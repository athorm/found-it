...
- [ ] The showing of numbers in the chat button of navbar seems to work, but when reading the message or viewing it. It does not update the number of messages. It should go down. How do we fix it? Should we use supabase to update the number of messages?
